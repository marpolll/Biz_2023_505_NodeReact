 ...
 * 전환해야 하는데 이때는 NavLink 를 사용하기가 다소 불편해진다.
...
/*
  App Component를  
  react-router-dom v6 에서 useRoutes() Hooks 함수를 생성하고
  router 를 return 하는 구조로 변경한다.
*/
function App() {
  // useNavigate hooks 함수를 사용하여 navigate 사용
  ...
  // AppBody Component 를 화면에 랜더링 한다..
